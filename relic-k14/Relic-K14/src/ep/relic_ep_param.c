...
#if defined(EP_ENDOM) && FP_PRIME == 340
/**
 * Parameters for BW14-P340
 */
/** @{ */
// #define BW14_P340_A		"0"
// #define BW14_P340_B		"2"
// #define BW14_P340_X		"43E78D4BEC40EE3C052747A6A4614903076B649BCBB0544C7D7822D1EFE8269A524CEB68DB4AF3C20C63B"
// #define BW14_P340_Y		"CD68EE78AE6CC9E63A89B692E32A0AA19F14EE0AC3F5A6065DE94DFF419A0C15A409129196248F077298"
// #define BW14_P340_R		"E0E982A238DC854CD2D85442A895261C02C5E651E9E90DC5AFD0784DE8BEF945"
// #define BW14_P340_H		"CDF1B93180C91EC4A9C5B"
// #define BW14_P340_BETA  "B4EF53117785F3C3F116E227C4A64C1B0B7E81DCE2858030DBD0351E0FF73FCE16AFC7EE835C30FDF701A"
// #define BW14_P340_LAMB	"E0E982A238DC854CD2D85442A86FC39F2CDEDAB2D304C5A8CFAB331808A6B945"
// #define BW14_P340_MAPU	"15"
// #endif
#define BW14_P340_A		"0"
#define BW14_P340_B		"2"
#define BW14_P340_X		"43E78D4BEC40EE3C052747A6A4614903076B649BCBB0544C7D7822D1EFE8269A524CEB68DB4AF3C20C63B"
...
#define BW14_P340_H		"CDF1B93180C91EC4A9C5B"
#define BW14_P340_BETA  "B4EF53117785F3C3F116E227C4A64C1B0B7E81DCE2858030DBD0351E0FF73FCE16AFC7EE835C30FDF701A"
#define BW14_P340_LAMB	"25627CD5E70B9F16E4481CE0254535E0183FFF"
#define BW14_P340_MAPU	"15"

#endif


#if defined(EP_ENDOM) && FP_PRIME == 351
/**
 * Parameters for BW14-P351
 */
/** @{ */
#define BW14_P351_A		"0"
#define BW14_P351_B		"3"
#define BW14_P351_X		"426DA5F4648DC56B3CF55ED1302E85FC37AB1837B92CC112F1A66621FD31CC6B88E6B4BE07C636FD46F7090F"
#define BW14_P351_Y		"580918F8EC6F5FF7C9699A5A616BFECC860AC82080B3F41BEF005E6929023A9E58B2FE17CCBF48B6DDF5329E"
#define BW14_P351_R		"10F5C2568986E859098113999F6D23DBCD80C79E0682DD4E2843B23FC7E4DBBB041"
#define BW14_P351_H		"5701C841E8172BA89D5AAB"
#define BW14_P351_BETA  "2DE3EACEE5C8E8D4FA7A1ABD0C63A91A37A81BB04A2DFF4077974E53890591DDD233C75E9A40331AA6B"
#define BW14_P351_LAMB	"10F5C2568986E859098113999F6CE1A5559842547BE6C2822D13241007E4DBBB040"
#define BW14_P351_MAPU	"15"
...
int ep_param_set_any_pairf(void) {
	...
	degree = 13;
#elif FP_PRIME == 340
	ep_param_set(BW14_P340);
	type =  RLC_EP_DTYPE;
	degree = 7;
#elif FP_PRIME == 351
	ep_param_set(BW14_P351);
	type =  RLC_EP_DTYPE;
	degree = 7;
#elif FP_PRIME == 315
	ep_param_set(B24_P315);
...
void ep_param_print(void) {
	switch (ep_param_get()) {
		...
		case BW13_P310:
			...
			break;
		case BW14_P340:
			util_banner("Curve BW14_P340:", 0);
			break;
		case BW14_P351:
			util_banner("Curve BW14_P351:", 0);
			break;
		case B24_P315:
