 ...
 */
static void ep7_dbl_basic_imp(ep7_t r, fp7_t s, const ep7_t p) {
	fp7_t t0, t1, t2;
 ...
 * @param[in] p					- the point to double.
 */
static void ep7_dbl_projc_imp(ep7_t r, const ep7_t p) {
	fp7_t t0, t1, t2, t3, t4, t5;
