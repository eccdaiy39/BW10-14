...
/**
 * Random prime modulus for the BW14_340.
 */

#define BW14_PR340		"B4EF5C241F7ECE2D13BF856AFF6E12CF86C2C31C03A9E89DC6078B436E57CAA68DB5FEC5861E97A93C503"
#endif

#if FP_PRIME == 351

/**
 * Random prime modulus for the BW14_351.
 */

#define BW14_PR351		"5C3A34588AD96FED11BDEAF919DDC57E3094457F7FBECA781F42B3A7864078310F8EBC79C18C5962A872E52B"
...
#elif FP_PRIME == 340
	fp_param_set(BW14_340);		
#elif FP_PRIME == 351
	fp_param_set(BW14_351);	
#elif FP_PRIME == 315
