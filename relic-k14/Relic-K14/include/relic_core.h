...
typedef struct _ctx_t {
...
#ifdef WITH_EPX
	/** The generator of the elliptic curve over Fp^7. */
	ep7_st ep7_g;
	/** The 'a' coefficient of the curve. */
	fp7_t ep7_a;
	/** The 'b' coefficient of the curve. */
	...
	int ep7_is_twist;
		/** Precomputation table for generator multiplication.*/
	ep7_st ep7_pre[RLC_EP_TABLE];
	/** Array of pointers to the precomputation table. */
	ep7_st *ep7_ptr[RLC_EP_TABLE];
#endif /* WITH_EPX */
    ...
    /** Constants for computing Frobenius maps in senventh extension field. @{ */
	/** @} */
    	fp7_t frb7_1;
    	fp7_t frb7_2;
    	fp7_t frb7_3;
