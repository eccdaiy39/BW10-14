...
static void arith13(void) {
	...
	BENCH_RUN("fp13_sub") {
		fp13_rand(a);
		fp13_rand(b);
		BENCH_ADD(fp13_sub(c, a, b));
	}
	BENCH_END;

	BENCH_RUN("fp13_dbl") {
		fp13_rand(a);
		BENCH_ADD(fp13_dbl(c, a));
	}
	BENCH_END;
	...
	BENCH_RUN("fp13_sqr") {
		fp13_rand(a);
		BENCH_ADD(fp13_sqr(c, a));
	}
	BENCH_END;

	BENCH_RUN("fp13_inv") {
		fp13_rand(a);
		BENCH_ADD(fp13_inv(c, a));
	}
	BENCH_END;
	...
	BENCH_RUN("fp13_exp") {
		...
		d->used = RLC_FP_DIGS;
		dv_copy(d->dp, fp_prime_get(), RLC_FP_DIGS);
		BENCH_ADD(fp13_exp(c, a, d));
	}
	BENCH_END;

	BENCH_RUN("fp13_frb") {
		fp13_rand(a);
		BENCH_ADD(fp13_frb(c, a, 1));
	}
	BENCH_END;
...
static void arith7(void) {
	...
	BENCH_RUN("fp7_sub") {
		fp7_rand(a);
		fp7_rand(b);
		BENCH_ADD(fp7_sub(c, a, b));
	}
	BENCH_END;

	BENCH_RUN("fp7_dbl") {
		fp7_rand(a);
		BENCH_ADD(fp7_dbl(c, a));
	}
	BENCH_END;
...
#if FPX_RDC == LAZYR || !defined(STRIP)
	BENCH_RUN("fp7_mul_lazyr") {
		fp7_rand(a);
		fp7_rand(b);
		BENCH_ADD(fp7_mul_lazyr(c, a, b));
	}
	BENCH_END;
#endif
	...
	BENCH_RUN("fp7_inv") {
		fp7_rand(a);
		BENCH_ADD(fp7_inv(c, a));
	}
	BENCH_END;

	BENCH_RUN("fp7_frb") {
		fp7_rand(a);
		BENCH_ADD(fp7_frb(c, a, 1));
	}
	BENCH_END;
...
static void arith14(void) {
	...
	BENCH_RUN("fp14_sub") {
		fp14_rand(a);
		fp14_rand(b);
		BENCH_ADD(fp14_sub(c, a, b));
	}
	BENCH_END;

	BENCH_RUN("fp14_dbl") {
		fp14_rand(a);
		BENCH_ADD(fp14_dbl(c, a));
	}
	BENCH_END;
...
#if FPX_RDC == LAZYR || !defined(STRIP)
	BENCH_RUN("fp14_mul_lazyr") {
		fp14_rand(a);
		fp14_rand(b);
		BENCH_ADD(fp14_mul_lazyr(c, a, b));
	}
	BENCH_END;
#endif
	...
	BENCH_RUN("fp14_sqr") {
		fp14_rand(a);
		BENCH_ADD(fp14_sqr(c, a));
	}
	BENCH_END;


	BENCH_RUN("fp14_sqr_cyc") {
		fp14_rand(a);
		BENCH_ADD(fp14_sqr_cyc(c, a));
	}
	BENCH_END;

	BENCH_RUN("fp14_sqr_basic") {
		fp14_rand(a);
		BENCH_ADD(fp14_sqr_basic(c, a));
	}
	BENCH_END;

	BENCH_RUN("fp14_inv") {
		fp14_rand(a);
		BENCH_ADD(fp14_inv(c, a));
	}
	BENCH_END;
	...
	BENCH_RUN("fp14_exp") {
		...
		d->used = RLC_FP_DIGS;
		dv_copy(d->dp, fp_prime_get(), RLC_FP_DIGS);
		BENCH_ADD(fp14_exp(c, a, d));
	}
	BENCH_END;

	BENCH_RUN("fp14_exp_cyc_x") {
		fp14_rand(a);
		BENCH_ADD(fp14_exp_cyc_x(c, a));
	}
	BENCH_END;

	BENCH_RUN("fp14_frb") {
		fp14_rand(a);
		BENCH_ADD(fp14_frb(c, a, 1));
	}
	BENCH_END;
...
int main(void) {
	...
	if (ep_param_embed() == 14) {
		arith7();
		arith14();

    }
	if (ep_param_embed() == 13) {
        	arith13();
    }        	
